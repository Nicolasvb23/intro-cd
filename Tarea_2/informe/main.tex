...
Al eliminar las palabras funcionales del ingl\'{e}s (art\'{\i}culos, preposiciones, conjunciones), palabras como \textit{``the''}, \textit{``of''} o \textit{``in''} desaparecen del vocabulario y no pueden aparecer como flechas en el biplot. En la Figura~\ref{fig:biplot_stopwords} los t\'{e}rminos de mayor loading visibles son \textit{``reuters''} y \textit{``percent''}, que son palabras de contenido caracter\'{\i}sticas de ese medio. Contra lo intuitivo, PC1 cae de 3,2\% a 1,1\%: al eliminar los t\'{e}rminos m\'{a}s frecuentes se reduce la concentraci\'{o}n de varianza en la primera direcci\'{o}n, distribuy\'{e}ndola entre m\'{a}s componentes.
