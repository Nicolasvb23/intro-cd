...
\caption{PCA con \texttt{ngram\_range=(1,2)} y \texttt{max\_features=40.000}. El vocabulario de bigramas es demasiado grande para densificarse sin l\'{\i}mite, por lo que se acota a los 50.000 t\'{e}rminos m\'{a}s frecuentes.}
...
Al agregar bigramas el vocabulario incluye todas las secuencias de dos palabras consecutivas, lo que lo hace crecer hasta cientos de miles de t\'{e}rminos. Para hacer viable la densificaci\'{o}n se acot\'{o} a \texttt{max\_features=40.000}. El biplot (Figura~\ref{fig:biplot_bigrams}) revela expresiones compuestas caracter\'{\i}sticas: bigramas como \textit{``reuters reporting''}, \textit{``new york''} o \textit{``wall street''} pasan a ser features expl\'{\i}citas que no exist\'{\i}an con unigramas.
