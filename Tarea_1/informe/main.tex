...
\begin{itemize}
    ...
    \item \textbf{Reuters apenas menciona al resto.} En cifras normalizadas, menciona a cualquier otro medio en menos del 1\% de sus art\'{\i}culos (0,3\% a NYT, 0,3\% a CNBC, 0,9\% a People, 0\% a The Hill). Coherente con su estilo de cable: reporta hechos, no comenta lo que dijeron otros medios.
    ...
    \item \textbf{La normalizaci\'{o}n cambia el orden.} En el conteo absoluto The Hill aparec\'{\i}a citando mucho a NYT (180 menciones), pero al normalizar (6,5\% de sus art\'{\i}culos) se ve que es una fracci\'{o}n peque\~{n}a comparada con la dependencia de CNBC con Reuters (31,8\%). La matriz normalizada corrige el sesgo por volumen.
\end{itemize}
